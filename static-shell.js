document.addEventListener('DOMContentLoaded', () => {
  ...
  // Decision Relay interaction — curated demo
  const FIXTURES = {
    overloaded_day: {
      id: 'overloaded_day',
  ...
  if (m2mTextarea && m2mRunBtn) {
    ...
    m2mRefineBtn.addEventListener('click', async () => {
      ...
      try {
        ...
        m2mAnnouncer.textContent = "Plan revised. Updated plan is ready.";
      } catch(e) {
    ...
    m2mRunBtn.addEventListener('click', async () => {
      ...
      try {
        ...
        m2mRunBtn.textContent = 'Run the agents';
        m2mMissionHeading.focus();
        m2mAnnouncer.textContent = "Workflow complete. Your demo plan is ready.";
